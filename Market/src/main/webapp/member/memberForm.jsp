...
<meta charset="UTF-8">
<title>회원 가입</title>
<script src="/resources/js/checkvalidation.js"></script>
...
<body>
	...
	<div class="container my-3">
		...
		<form action="/addMember.do" method="post" name="newMember">
			...
			<div class="form-group row">
				<label class="col-sm-2 my-2">비밀번호 확인</label>
				<div class="col-sm-3">
			...
			<div class="form-group row">
				...
				<div class="col-sm-3 my-2">				
					<label><input type="radio" name="gender" value="male" checked="checked"/>남</label>
